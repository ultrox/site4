...
Even though `vim` related, this is teachable moment for the rest of us looking 
for actionable and concrete tip for changing our behaviour.                                                    

> When you remove the choice, or make it stupid hard/easy, one will predictably do more convenient action. 
